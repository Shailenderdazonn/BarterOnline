    ...
    <div className={styles.home}>
          ...
          <div className={styles.searchContainer}>
            <div className={styles.title}>
              <div
                ...
                data-animate-on-scroll
              >{`Let’s Us Help You Get Your Next Mobile! `}</div>
              <div
                className={styles.searchFromOver}
                data-animate-on-scroll
              >{`Search from over 1,00,000 classifieds & Post unlimited classifieds free!`}</div>
        ...
        <div className={styles.frameParent}>
          ...
          <div className={styles.rectangleGroup}>
            ...
            <div className={styles.frameParent1}>
              <div className={styles.frameContainer}>
                <div className={styles.frameDiv}>
                  <div className={styles.carsVehiclesParent}>
                    <div
                      className={styles.mobilePhone}
                    >{`Cars & vehicles`}</div>
                    <div className={styles.novaScotiaWrapper}>
                      <div className={styles.alberta}>Nova Scotia</div>
                    </div>
                  </div>
                  <b className={styles.iphone13Pro}>Hyundai Elite i20</b>
                </div>
                <div className={styles.wrapper}>
                  <b className={styles.b}> ₹ 6,75,000/-</b>
                </div>
              </div>
          ...
          <div className={styles.rectangleContainer}>
            ...
            <div className={styles.frameParent4}>
              <div className={styles.frameContainer}>
                <div className={styles.frameDiv}>
                  <div className={styles.carsVehiclesParent}>
                    <div className={styles.mobilePhone}>Real Estate</div>
                    <div className={styles.novaScotiaWrapper}>
                      <div className={styles.alberta}>Manitoba</div>
                    </div>
                  </div>
                  <b className={styles.iphone13Pro}>HP 2000 Notebook</b>
                </div>
                <div className={styles.wrapper}>
        ...
        <div className={styles.aboutUsBlurb}>
          <div className={styles.frameContainer}>
            ...
            <div className={styles.aboutUsDescription}>
              ...
              voluptates voluptas?quis exercitationem culpa nesciunt nihil aut
              nostrum voluptates voluptas?quis exercitationem culpa nesciunt
              nihil aut nostrum voluptates voluptas?
            </div>
          </div>
          <a className={styles.featuredDestinationCta}>
            ...
            <div className={styles.storyBigCard}>
              ...
              <div className={styles.bigStoryBody}>
                <div className={styles.bigStoryItems}>
                  ...
                  >
                    <div className={styles.viewBlog}> View Blog...</div>
                  </button>
                </div>
              </div>
            </div>
      ...
      <div className={styles.footerCol1}>
        ...
        <div className={styles.frameParent8}>
          <div className={styles.albertaParent}>
            <div className={styles.alberta1}>Alberta</div>
            <div className={styles.britishColumbia}>British Columbia</div>
            <div className={styles.manitoba1}>Manitoba</div>
            <div className={styles.newBrunswick}>New Brunswick</div>
          </div>
          <div className={styles.newfoundlandParent}>
            <div className={styles.newfoundland}>{`Newfoundland `}</div>
            <div className={styles.novaScotia1}>Nova Scotia</div>
            <div className={styles.ontario}>Ontario</div>
            <div className={styles.princeEdwardIsland}>
              Prince Edward Island
            </div>
            <div className={styles.ontario}>Quebec</div>
          </div>
        </div>
        <div className={styles.saskatchewanParent}>
          <div className={styles.saskatchewan}>Saskatchewan</div>
          <div className={styles.northwestTerritories}>
            Northwest Territories
          </div>
          <div className={styles.nunavut}>Nunavut</div>
          <div className={styles.yukon}>Yukon</div>
        </div>
      </div>
    </div>
  );
