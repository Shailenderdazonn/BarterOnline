  ...
  return (
    <div className={styles.login}>
      <div className={styles.mainSection}>
        <img className={styles.downloader1Icon} alt="" src="../bgimg@2x.png" />
        <div className={styles.mainContainer}>
          <div className={styles.mainContentContainer}>
            <div className={styles.loginForm}>
              <form className={styles.form} name="f1" action="http://localhost/Classifieds%20ad/src/API/authentication.php" onSubmit={validation} method="POST" >
                ...
                >
                  ...
                  >{`New To Company? Create An Account `}</div>
                </button>
              </form>
            </div>
          </div>
